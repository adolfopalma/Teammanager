...
public class ChronometerApplication extends Application {
    ...
    private static Notification mNotificationAppState;
    ...
    public void showNotification(ChronometerState state, String time) {
        ...
        String title = "Partido en curso";
        String msg = time;


        int icon = R.mipmap.ic_reloj;

        Intent notificationIntent = new Intent(this, PartidoActivity.class)
