...
//Clase para realizar conexion a traves de php(json) a la base de datos
public class ClaseConexion {
    ...
    //Metodo para insertar, borrar y modificar
    public JSONObject sendInsert(String link, HashMap<String, String> values) throws JSONException {
